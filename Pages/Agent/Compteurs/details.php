<?php
// Pages/Agent/Compteurs/details.php
session_start();
...
$page_title = 'Détails du compteur - SNEL Agent';
?>
<!DOCTYPE html>
<html lang="fr">
<head>
    ...
    <div class="p-4 lg:p-6">
        <div class="max-w-6xl mx-auto">
            ...
            <div class="card-snel">
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full">
                            ...
                            <tbody class="divide-y divide-gray-200">
                                <?php foreach (array_slice($consommations, 0, 15) as $conso): ?>
                ...
                <?php else: ?>
                    ...
                    <div class="text-center">
                        <a href="/Pages/Agent/Releves/nouveau.php?compteur=<?= $idCompteur ?>" class="btn-secondary text-sm px-4 py-2 rounded-lg inline-flex items-center">
                            <i class="fas fa-edit mr-2"></i> Effectuer un relevé
                        </a>
                    </div>
                <?php endif; ?>
            </div>
            ...
            <div class="flex flex-wrap justify-center gap-4 mt-6">
                ...
                <a href="modifier.php?id=<?= $idCompteur ?>" class="btn-primary px-6 py-2 rounded-lg">
                    <i class="fas fa-pen mr-2"></i> Modifier
                </a>
                <?php if ($user->getRole() === 'administrateur'): ?>
                    <a href="#" class="btn-primary px-6 py-2 rounded-lg" style="background:#dc2626;" 
